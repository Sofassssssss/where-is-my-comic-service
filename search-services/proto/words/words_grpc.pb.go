...
const (
	...
	Words_NormLeaveDuplicates_FullMethodName = "/words.Words/NormLeaveDuplicates"
)
...
type WordsClient interface {
	...
	NormLeaveDuplicates(ctx context.Context, in *WordsRequest, opts ...grpc.CallOption) (*WordsReply, error)
}
...
func (c *wordsClient) NormLeaveDuplicates(ctx context.Context, in *WordsRequest, opts ...grpc.CallOption) (*WordsReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(WordsReply)
	err := c.cc.Invoke(ctx, Words_NormLeaveDuplicates_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WordsServer interface {
	...
	NormLeaveDuplicates(context.Context, *WordsRequest) (*WordsReply, error)
...
func (UnimplementedWordsServer) NormLeaveDuplicates(context.Context, *WordsRequest) (*WordsReply, error) {
	return nil, status.Error(codes.Unimplemented, "method NormLeaveDuplicates not implemented")
}
...
func _Words_NormLeaveDuplicates_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(WordsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WordsServer).NormLeaveDuplicates(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Words_NormLeaveDuplicates_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WordsServer).NormLeaveDuplicates(ctx, req.(*WordsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Words_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "NormLeaveDuplicates",
			Handler:    _Words_NormLeaveDuplicates_Handler,
		},
	},
