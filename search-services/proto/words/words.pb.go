...
const file_words_proto_rawDesc = "" +
	"\n" +
	"\vwords.proto\x12\x05words\x1a\x1bgoogle/protobuf/empty.proto\"&\n" +
	"\fWordsRequest\x12\x16\n" +
	"\x06phrase\x18\x01 \x01(\tR\x06phrase\"\"\n" +
	"\n" +
	"WordsReply\x12\x14\n" +
	"\x05words\x18\x01 \x03(\tR\x05words2\xb4\x01\n" +
	"\x05Words\x128\n" +
	"\x04Ping\x12\x16.google.protobuf.Empty\x1a\x16.google.protobuf.Empty\"\x00\x120\n" +
	"\x04Norm\x12\x13.words.WordsRequest\x1a\x11.words.WordsReply\"\x00\x12?\n" +
	"\x13NormLeaveDuplicates\x12\x13.words.WordsRequest\x1a\x11.words.WordsReply\"\x00B\x1eZ\x1cyadro.com/course/proto/wordsb\x06proto3"

var (
	file_words_proto_rawDescOnce sync.Once
	file_words_proto_rawDescData []byte
)

func file_words_proto_rawDescGZIP() []byte {
	file_words_proto_rawDescOnce.Do(func() {
		file_words_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_words_proto_rawDesc), len(file_words_proto_rawDesc)))
	})
...
var file_words_proto_depIdxs = []int32{
	...
	0, // 2: words.Words.NormLeaveDuplicates:input_type -> words.WordsRequest
	2, // 3: words.Words.Ping:output_type -> google.protobuf.Empty
	1, // 4: words.Words.Norm:output_type -> words.WordsReply
	1, // 5: words.Words.NormLeaveDuplicates:output_type -> words.WordsReply
...
func file_words_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_words_proto_rawDesc), len(file_words_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
